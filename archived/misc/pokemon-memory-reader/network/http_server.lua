...
function HttpServer:start()
    ...
    console.log("  GET /enemy - Get enemy party information")
    console.log("  GET /battle - Get battle Pokemon information")
...
function HttpServer:handleRequest(client, requestLine)
    ...
    if method == "GET" then
        ...
        elseif path == "/enemy" then
            apiHandlers.handleEnemyRequest(client, self.memoryReader)
        elseif path == "/battle" then
            apiHandlers.handleBattleRequest(client, self.memoryReader)
        elseif path == "/map" then
            apiHandlers.handleMapRequest(client, self.memoryReader)
        elseif path == "/input" then
            apiHandlers.handleInputRequest(client, self.memoryReader, query)
